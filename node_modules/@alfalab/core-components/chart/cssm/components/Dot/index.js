...
var Dot = React__default['default'].forwardRef(function (_a, ref) {
    ...
    if (!value)
        return null;
    return (React__default['default'].createElement("g", { ref: ref, className: cn__default['default'](styles__default['default'].dot), transform: "translate(" + (cx - width / 2) + ", " + (cy - height / 2) + ")" },
        React__default['default'].createElement("g", { className: cn__default['default'](styles__default['default'].dotWrap), transform: "scale(" + (activeDot === index ? (option === null || option === void 0 ? void 0 : option.scale) || 0 : (option === null || option === void 0 ? void 0 : option.initScale) || 0) + ")" },
