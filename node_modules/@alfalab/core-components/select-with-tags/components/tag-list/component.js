...
var TagList = function (_a) {
    ...
    return (React__default['default'].createElement("div", { ref: wrapperRef, onFocus: handleFocus, onBlur: handleBlur, className: cn__default['default'](className, styles.component, styles[size]) },
        React__default['default'].createElement(coreComponentsFormControl.FormControl, tslib_es6.__assign({}, restProps, { ref: innerProps.ref, fieldClassName: cn__default['default'](fieldClassName, styles.field, (_b = {},
                _b[styles.focusVisible] = focusVisible,
                _b)), block: true, size: size, focused: open || focused, disabled: disabled, filled: filled || !!placeholder, onMouseDown: handleMouseDown, rightAddons: Arrow, onClick: handleClick, addonsClassName: cn__default['default'](styles.addons, styles["addons-size-" + size]), label: label, labelClassName: styles.label }),
            React__default['default'].createElement("div", { className: cn__default['default'](styles.contentWrapper, (_c = {},
                ...
                autocomplete && (React__default['default'].createElement("input", tslib_es6.__assign({}, restInnerProps, { autoComplete: 'off', ref: inputRef, value: value, onChange: onInput, className: cn__default['default'](styles.input, (_d = {},
                ...
                placeholder && !filled && !autocomplete && (React__default['default'].createElement("span", { className: styles.placeholder }, placeholder))))));
};
