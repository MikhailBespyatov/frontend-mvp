...
var SteppedProgressBar = function (_a) {
    var maxStep = _a.maxStep, description = _a.description, _b = _a.step, step = _b === void 0 ? 0 : _b, dataTestId = _a.dataTestId, className = _a.className;
    ...
    return (React__default['default'].createElement("div", { className: cn__default['default'](styles__default['default'].component, className), "data-test-id": dataTestId },
        React__default['default'].createElement("div", { className: styles__default['default'].stepsContainer }, Array.from(Array(validMaxSteps), function (_, index) { return (React__default['default'].createElement(components_stepBar_Component.StepBar, { key: index, isDone: index < step })); })),
