...
type NativeProps = Omit<InputHTMLAttributes<HTMLInputElement>, 'min' | 'max' | 'step' | 'value' | 'type' | 'onChange'>;
type SliderProps = NativeProps & {
    /**
