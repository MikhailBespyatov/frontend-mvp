...
.select__option_je09f:first-child:before {
        display: none;
    }
.select__s_je09f {
...
.select__l_je09f:before, .select__xl_je09f:before {
...
.select__highlighted_je09f:before,
    .select__highlighted_je09f + .select__option_je09f:before {
        opacity: 0;
    }
...
.select__content_je09f {
    overflow: hidden;
    text-overflow: ellipsis;
    flex: 1;
}
.select__textContent_je09f {
    padding-top: var(--gap-s);
    padding-bottom: var(--gap-s);
}
/* IE min-height fix */
@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {
    .select__option_je09f:after {
        min-height: inherit;
        font-size: 0;
        content: '';
    }
