...
var Field = function (_a) {
    var _b;
    var _c = _a.size, size = _c === void 0 ? 'm' : _c, open = _a.open, multiple = _a.multiple, error = _a.error, hint = _a.hint, disabled = _a.disabled, label = _a.label, placeholder = _a.placeholder, _d = _a.selectedMultiple, selectedMultiple = _d === void 0 ? [] : _d, selected = _a.selected, rightAddons = _a.rightAddons, _e = _a.valueRenderer, valueRenderer = _e === void 0 ? utils.joinOptions : _e, setSelectedItems = _a.setSelectedItems, toggleMenu = _a.toggleMenu, Arrow = _a.Arrow, innerProps = _a.innerProps, dataTestId = _a.dataTestId, fieldClassName = _a.fieldClassName, restProps = tslib_es6.__rest(_a, ["size", "open", "multiple", "error", "hint", "disabled", "label", "placeholder", "selectedMultiple", "selected", "rightAddons", "valueRenderer", "setSelectedItems", "toggleMenu", "Arrow", "innerProps", "dataTestId", "fieldClassName"]);
    ...
    return (React__default['default'].createElement("div", { className: styles__default['default'].component, ref: wrapperRef, onFocus: handleFocus, onBlur: handleBlur },
        React__default['default'].createElement(coreComponentsFormControl.FormControl, tslib_es6.__assign({ fieldClassName: cn__default['default'](styles__default['default'].field, fieldClassName, (_b = {},
                ...
                _b)), block: true, size: size, focused: open || focused, disabled: disabled, filled: filled, label: showLabel && label, error: error, hint: hint, rightAddons: (Arrow || rightAddons) && (React__default['default'].createElement(React__default['default'].Fragment, null,
                rightAddons,
