...
function useLazyLoading(_a) {
    var _b = _a.limit, limit = _b === void 0 ? 10 : _b, _c = _a.initialOffset, initialOffset = _c === void 0 ? 0 : _c, optionsFetcher = _a.optionsFetcher, _d = _a.skeleton, skeleton = _d === void 0 ? React__default['default'].createElement(coreComponentsSkeleton.Skeleton, { className: styles.skeleton, visible: true }) : _d;
    var initialOptions = [];
