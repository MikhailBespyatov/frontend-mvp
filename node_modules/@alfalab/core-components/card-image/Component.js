...
var CardImage = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: cn__default['default'](styles.cardImage, rounded && styles.rounded, loaded && styles.loaded, className), style: {
            width: width,
            height: height,
        }, id: id, "data-test-id": dataTestId }, cardId && (React__default['default'].createElement("img", { ref: image, className: styles.image, width: width, height: height, src: cardImageUrl, srcSet: cardImageUrl2x + " 2x", alt: alt, role: 'presentation', onLoad: handleLoadedImage }))));
};
