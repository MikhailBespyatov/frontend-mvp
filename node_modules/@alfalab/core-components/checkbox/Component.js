...
var CheckedIcon = require('@alfalab/icons-glyph/CheckmarkCompactMIcon');
...
var CheckedIcon__default = /*#__PURE__*/_interopDefaultLegacy(CheckedIcon);
...
var Checkbox = React.forwardRef(function (_a, ref) {
    var _b;
    var checked = _a.checked, label = _a.label, hint = _a.hint, _c = _a.size, size = _c === void 0 ? 's' : _c, _d = _a.align, align = _d === void 0 ? 'start' : _d, addons = _a.addons, block = _a.block, onChange = _a.onChange, className = _a.className, name = _a.name, disabled = _a.disabled, inactive = _a.inactive, dataTestId = _a.dataTestId, _e = _a.indeterminate, indeterminate = _e === void 0 ? false : _e, error = _a.error, restProps = __rest(_a, ["checked", "label", "hint", "size", "align", "addons", "block", "onChange", "className", "name", "disabled", "inactive", "dataTestId", "indeterminate", "error"]);
    ...
    React__default['default'].createElement("label", { className: cn__default['default'](styles.component, styles[size], styles[align], className, (_b = {},
        ...
        React__default['default'].createElement("span", { className: styles.box },
            checked && React__default['default'].createElement(CheckedIcon__default['default'], { className: styles.checkedIcon }),
            indeterminate && !checked && React__default['default'].createElement("span", { className: styles.indeterminateLine })),
