...
var coreComponentsToastPlate = require('../toast-plate');
...
var Toast = React.forwardRef(function (_a, ref) {
    var _b;
    var anchorElement = _a.anchorElement, position = _a.position, offset = _a.offset, open = _a.open, _c = _a.autoCloseDelay, autoCloseDelay = _c === void 0 ? 3000 : _c, className = _a.className, bottomOffset = _a.bottomOffset, _d = _a.style, style = _d === void 0 ? {} : _d, block = _a.block, _e = _a.zIndex, zIndex = _e === void 0 ? coreComponentsStack.stackingOrder.TOAST : _e, _f = _a.ToastPlate, ToastPlate = _f === void 0 ? DefaultToastPlate : _f, onMouseEnter = _a.onMouseEnter, onMouseLeave = _a.onMouseLeave, onTouchStart = _a.onTouchStart, onClose = _a.onClose, getPortalContainer = _a.getPortalContainer, restProps = __rest(_a, ["anchorElement", "position", "offset", "open", "autoCloseDelay", "className", "bottomOffset", "style", "block", "zIndex", "ToastPlate", "onMouseEnter", "onMouseLeave", "onTouchStart", "onClose", "getPortalContainer"]);
    ...
    if (anchorElement) {
        return (React__default['default'].createElement(coreComponentsPopover.Popover, { open: open, anchorElement: anchorElement, position: position, offset: offset, popperClassName: styles.popoverInner, className: cn__default['default']((_b = {}, _b[styles.block] = block, _b)), transition: { timeout: 150 }, getPortalContainer: getPortalContainer, zIndex: zIndex },
    ...
    return (React__default['default'].createElement(coreComponentsStack.Stack, { value: zIndex }, function (computedZIndex) { return (React__default['default'].createElement(coreComponentsPortal.Portal, { getPortalContainer: getPortalContainer },
        React__default['default'].createElement(reactTransitionGroup.CSSTransition, { unmountOnExit: true, in: open, timeout: 150, classNames: CSS_TRANSITION_CLASS_NAMES },
            React__default['default'].createElement(ToastPlate, __assign({}, restProps, { className: cn__default['default'](styles.fixed, styles.toastPlate, className), style: __assign(__assign({}, style), { bottom: bottomOffset && bottomOffset + "px", zIndex: computedZIndex }) }, props))))); }));
});
