...
var Toast = forwardRef(function (_a, ref) {
    ...
    if (anchorElement) {
        return (React.createElement(Popover, { open: open, anchorElement: anchorElement, position: position, offset: offset, popperClassName: styles.popoverInner, className: cn((_b = {}, _b[styles.block] = block, _b)), transition: { timeout: 150 }, getPortalContainer: getPortalContainer, zIndex: zIndex },
    ...
    return (React.createElement(Stack, { value: zIndex }, function (computedZIndex) { return (React.createElement(Portal, { getPortalContainer: getPortalContainer },
        React.createElement(CSSTransition, { unmountOnExit: true, in: open, timeout: 150, classNames: CSS_TRANSITION_CLASS_NAMES },
            React.createElement(ToastPlate, __assign({}, restProps, { className: cn(styles.fixed, styles.toastPlate, className), style: __assign(__assign({}, style), { bottom: bottomOffset && bottomOffset + "px", zIndex: computedZIndex }) }, props))))); }));
});
