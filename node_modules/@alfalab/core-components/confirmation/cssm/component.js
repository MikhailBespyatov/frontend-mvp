...
require('./components/countdown/component.js');
require('../../loader/cssm');
...
var Confirmation = React.forwardRef(function (_a, ref) {
    ...
    var handleCountdownFinished = React.useCallback(function () {
    ...
    var handleErrorSmsRetryClick = React.useCallback(function () {
    ...
    return (React__default['default'].createElement("div", { className: cn__default['default'](styles__default['default'].component, styles__default['default'][alignContent], className), ref: ref, "data-test-id": dataTestId },
        ...
        shouldShowHint && (React__default['default'].createElement("div", { className: styles__default['default'].phoneHintWrap },
            React__default['default'].createElement("span", { className: styles__default['default'].errorHeader }, "\u041D\u0435\u00A0\u043F\u0440\u0438\u0445\u043E\u0434\u0438\u0442 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435?"),
            React__default['default'].createElement("span", { className: styles__default['default'].phoneHintText }, "\u0415\u0441\u043B\u0438 \u0443\u00A0\u0432\u0430\u0441 \u0441\u043C\u0435\u043D\u0438\u043B\u0441\u044F \u043D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430, \u043F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430, \u043E\u0431\u0440\u0430\u0442\u0438\u0442\u0435\u0441\u044C \u0432\u00A0\u043B\u044E\u0431\u043E\u0435 \u043E\u0442\u0434\u0435\u043B\u0435\u043D\u0438\u0435 \u0431\u0430\u043D\u043A\u0430."),
            React__default['default'].createElement("div", { className: styles__default['default'].phonesWrap },
                React__default['default'].createElement("div", { className: styles__default['default'].phoneWrap },
                    React__default['default'].createElement(coreComponentsLink.Link, { className: styles__default['default'].phoneLink, href: 'tel:+78002000000' }, "8 800 200-00-00"),
                    React__default['default'].createElement("span", { className: styles__default['default'].phoneDescription },
                        ' ',
                        "\u2014\u00A0\u0434\u043B\u044F \u0437\u0432\u043E\u043D\u043A\u043E\u0432 \u043F\u043E\u00A0\u0420\u043E\u0441\u0441\u0438\u0438")),
                React__default['default'].createElement("div", { className: styles__default['default'].phoneWrap },
                    React__default['default'].createElement(coreComponentsLink.Link, { className: styles__default['default'].phoneLink, href: 'tel:+74957888878' }, "+7 495 788-88-78"),
                    React__default['default'].createElement("span", { className: styles__default['default'].phoneDescription },
                        ' ',
                        "\u2014\u00A0\u0432\u00A0\u041C\u043E\u0441\u043A\u0432\u0435 \u0438\u00A0\u0437\u0430\u00A0\u0433\u0440\u0430\u043D\u0438\u0446\u0435\u0439"))),
            React__default['default'].createElement(coreComponentsButton.Button, { className: styles__default['default'].repeatButton, size: 'xs', view: 'secondary', onClick: handleSmsRetryFromHintClick }, buttonReturnText)))));
});
/**
