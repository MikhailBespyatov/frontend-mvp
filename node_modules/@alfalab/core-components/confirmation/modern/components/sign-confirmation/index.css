...
.confirmation__component_srlhu {
    display: flex;
    flex-direction: column;
}
.confirmation__countdown_srlhu {
    max-height: 300px;
    overflow: hidden;
    transition: max-height 0.15s ease;
}
.confirmation__hidden_srlhu {
    opacity: 0;
    max-height: 0;
}
...
.confirmation__inputContainer_srlhu {
    display: flex;
    flex-direction: column;
}
.confirmation__smsComeLinkWrap_srlhu {
    margin-top: var(--gap-l);
}
.confirmation__smsComeLink_srlhu {
    font-size: 14px;
    line-height: 20px;
    font-weight: 400;
}
...
.confirmation__loaderWrap_srlhu {
    display: flex;
    align-items: center;
...
.confirmation__center_srlhu .confirmation__codeInput_srlhu,
    .confirmation__center_srlhu .confirmation__loaderWrap_srlhu {
