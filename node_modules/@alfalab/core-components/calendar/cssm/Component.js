...
var Calendar = React.forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement("div", tslib_es6.__assign({}, getRootProps({ ref: ref }), { className: cn__default['default'](styles__default['default'].component, className, (_b = {},
        ...
        React__default['default'].createElement(components_header_Component.Header, { view: selectorView, withShadow: scrolled },
            React__default['default'].createElement(components_periodSlider_Component.PeriodSlider, { className: styles__default['default'].period, value: activeMonth, periodType: 'month', prevArrowDisabled: !canSetPrevMonth, nextArrowDisabled: !canSetNextMonth, hideDisabledArrows: true, onPrevArrowClick: handlePrevArrowClick, onNextArrowClick: handleNextArrowClick, onMonthClick: handleMonthClick, onYearClick: handleYearClick, view: selectorView === 'month-only' ? 'period' : 'full' })),
