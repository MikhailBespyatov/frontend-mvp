...
var PeriodSlider = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: cn__default['default'](styles__default['default'].component, className, (_c = {},
            _c[styles__default['default'].full] = view === 'full',
            _c)), "aria-live": 'polite', "data-test-id": dataTestId },
        showPrevButton && (React__default['default'].createElement(coreComponentsButton.Button, { view: 'ghost', className: styles__default['default'].arrow, onClick: handlePrevArrowClick, disabled: prevArrowDisabled, "aria-label": '\u041F\u0440\u0435\u0434\u044B\u0434\u0443\u0449\u0438\u0439 \u043F\u0435\u0440\u0438\u043E\u0434' })),
        view === 'full' ? (React__default['default'].createElement(React__default['default'].Fragment, null,
            React__default['default'].createElement(components_selectButton_Component.SelectButton, { view: 'filled', className: styles__default['default'].month, onClick: onMonthClick },
                React__default['default'].createElement("span", { className: styles__default['default'].buttonContent },
                    month,
                    React__default['default'].createElement("span", { className: styles__default['default'].upDownIcon }))),
        ...
        showNextButton && (React__default['default'].createElement(coreComponentsButton.Button, { view: 'ghost', className: styles__default['default'].arrow, onClick: handleNextArrowClick, disabled: nextArrowDisabled, "aria-label": '\u0421\u043B\u0435\u0434\u0443\u044E\u0449\u0438\u0439 \u043F\u0435\u0440\u0438\u043E\u0434' }))));
};
