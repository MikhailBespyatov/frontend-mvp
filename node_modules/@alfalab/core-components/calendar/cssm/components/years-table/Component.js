...
var YearsTable = function (_a) {
    ...
    React.useLayoutEffect(function () {
        ...
        var selector = "." + styles__default['default'].button + "[tabIndex=\"0\"]";
    ...
    return (React__default['default'].createElement("div", { className: styles__default['default'].yearsTable, onScroll: handleScroll, ref: ref },
