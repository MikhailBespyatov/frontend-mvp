...
declare const CustomButton: React.ForwardRefExoticComponent<(Partial<AnchorButtonProps> & React.RefAttributes<HTMLAnchorElement | HTMLButtonElement>) | (Partial<NativeButtonProps> & React.RefAttributes<HTMLAnchorElement | HTMLButtonElement>)>;
