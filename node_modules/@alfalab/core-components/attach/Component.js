...
var coreComponentsProgressBar = require('../progress-bar');
var coreComponentsKeyboardFocusable = require('../keyboard-focusable');
...
var Attach = React__default['default'].forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement("div", { className: cn__default['default'](styles.component, styles[size], (_b = {},
        ...
        files && files.length > 0 ? (React__default['default'].createElement("div", { className: cn__default['default'](styles.file, fileClassName) },
            ...
            progressBarPercent && (React__default['default'].createElement(coreComponentsProgressBar.ProgressBar, { className: styles.progressBar, value: progressBarPercent, view: 'positive' })))) : (React__default['default'].createElement("div", { className: cn__default['default'](styles.noFile, noFileClassName) }, noFileText))));
});
/**
