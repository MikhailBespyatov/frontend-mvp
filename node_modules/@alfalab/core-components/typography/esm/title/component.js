import { a as __rest, _ as __assign, c as colors } from '../colors.module-b5437a3d.js';
...
var Title = forwardRef(function (_a, ref) {
    ...
    return (React.createElement(Component, __assign({ className: cn(styles.component, className, styles[font + "-" + view], defaultMargins && styles["margins-" + view], styles[weight], color && colors[color]), "data-test-id": dataTestId, ref: ref }, restProps), children));
});
