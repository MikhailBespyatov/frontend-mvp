...
.radio__container_1n0kc.radio__disabled_1n0kc {
...
.radio__container_1n0kc.radio__inactive_1n0kc {
        cursor: var(--disabled-cursor)
    }
...
.radio__container_1n0kc.radio__checked_1n0kc:not(:active) .radio__circle_1n0kc:before,
    .radio__container_1n0kc.radio__checked_1n0kc.radio__disabled_1n0kc:active .radio__circle_1n0kc:before {
        opacity: 1;
    }
...
.radio__s_1n0kc .radio__circle_1n0kc {
    width: 16px;
    height: 16px;
    margin: var(--gap-2xs) var(--gap-3xs);
}
.radio__content_1n0kc {
    display: flex;
    flex-direction: column;
    margin-left: var(--gap-s);
}
.radio__s_1n0kc .radio__content_1n0kc {
