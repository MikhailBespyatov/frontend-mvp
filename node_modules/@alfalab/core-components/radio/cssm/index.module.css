...
.container:not(.checked):not(.disabled):not(.inactive) .circle {
            background-color: var(--radio-bg-color);
            border: 1.5px solid var(--radio-border-color);
        }
.container:not(.checked):not(.disabled):not(.inactive):hover:not(:active) .circle {
            background-color: var(--radio-hover-bg-color);
            border-color: var(--radio-hover-border-color);
        }
.container:not(.checked):not(.disabled):not(.inactive):active .circle {
