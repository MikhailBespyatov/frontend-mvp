...
var Link = React.forwardRef(function (_a, ref) {
    var _b, _c;
    var _d = _a.view, view = _d === void 0 ? 'primary' : _d, _e = _a.pseudo, pseudo = _e === void 0 ? false : _e, leftAddons = _a.leftAddons, rightAddons = _a.rightAddons, className = _a.className, dataTestId = _a.dataTestId, children = _a.children, _f = _a.colors, colors = _f === void 0 ? 'default' : _f, href = _a.href, _g = _a.Component, Component = _g === void 0 ? 'a' : _g, restProps = __rest(_a, ["view", "pseudo", "leftAddons", "rightAddons", "className", "dataTestId", "children", "colors", "href", "Component"]);
    var linkRef = React.useRef(null);
    var focused = hooks.useFocus(linkRef, 'keyboard')[0];
    var componentProps = (_b = {
            className: cn__default['default'](styles.component, colorStyles[colors][view], (_c = {},
        ...
        _b[typeof Component === 'string' ? 'href' : 'to'] = href,
        _b);
    return (React__default['default'].createElement(Component, __assign({}, componentProps, restProps, { ref: mergeRefs__default['default']([linkRef, ref]) }), leftAddons || rightAddons ? (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        children && (React__default['default'].createElement("span", null,
            React__default['default'].createElement("span", { className: styles.text }, children))),
        rightAddons && React__default['default'].createElement("span", { className: styles.addons }, rightAddons))) : (React__default['default'].createElement("span", { className: styles.text }, children))));
});
/**
