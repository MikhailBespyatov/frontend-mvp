...
var Tooltip = function (_a) {
    ...
    var clickedOutside = React.useCallback(function (node) {
    ...
    var getTargetProps = function () {
        var props = {
            className: cn__default['default'](styles.target, targetClassName),
        };
        switch (trigger) {
            case 'click':
                return exports.__assign(exports.__assign({}, props), onClickProps);
            case 'hover':
                return exports.__assign(exports.__assign({}, props), onHoverProps);
            default:
                return {};
        }
    };
    var getContentProps = function () {
        var props = {
            ...
            className: cn__default['default'](styles.component, contentClassName),
        };
        switch (trigger) {
            case 'hover':
                return exports.__assign(exports.__assign({}, props), onHoverProps);
    ...
    return (React__default['default'].createElement(React.Fragment, null,
        React__default['default'].createElement("div", exports.__assign({ ref: mergeRefs__default['default']([targetRef, setTarget]) }, getTargetProps()),
            children.props.disabled && React__default['default'].createElement("div", { className: styles.overlap }),
            children),
        React__default['default'].createElement(coreComponentsPopover.Popover, { anchorElement: target, open: show, getPortalContainer: getPortalContainer, arrowClassName: cn__default['default'](arrowClassName, styles.arrow), popperClassName: cn__default['default'](styles.popper, styles[view]), className: popoverClassName, offset: offset, withArrow: true, position: position, update: updatePopover, zIndex: zIndex, fallbackPlacements: fallbackPlacements, preventOverflow: preventOverflow, availableHeight: availableHeight },
            React__default['default'].createElement("div", exports.__assign({}, getContentProps()), content))));
};
