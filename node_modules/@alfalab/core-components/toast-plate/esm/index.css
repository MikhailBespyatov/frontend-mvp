...
.toast-plate__component_1xs17.toast-plate__hasCloser_1xs17 {
        /* 2×16 + 24 */
        padding-right: 56px;
    }
.toast-plate__contentWrap_1xs17 {
    display: flex;
}
.toast-plate__block_1xs17 {
    display: flex;
    width: 100%;
}
.toast-plate__content_1xs17 {
    display: flex;
    flex-grow: 1;
}
.toast-plate__actionSection_1xs17 {
    display: flex;
...
.toast-plate__actionSection_1xs17:last-child {
        padding-right: 0;
    }
.toast-plate__leftAddons_1xs17 {
    display: flex;
    align-items: flex-start;
    flex-shrink: 0;
    padding-right: var(--gap-s);
}
.toast-plate__title_1xs17 {
    font-size: 16px;
    line-height: 24px;
    font-weight: 700;
...
.toast-plate__title_1xs17 + .toast-plate__children_1xs17 {
    margin-top: var(--gap-2xs);
}
.toast-plate__closeButton_1xs17 {
    display: flex;
    align-items: flex-start;
    position: absolute;
    top: var(--gap-s);
...
.toast-plate__actionSection_1xs17 + .toast-plate__closeButton_1xs17 {
    align-items: var(--toast-plate-action-align)
}
