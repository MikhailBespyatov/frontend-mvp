...
var Input = React__default['default'].forwardRef(function (_a, ref) {
    ...
    var renderRightAddons = function () {
        ...
        return (addonsVisible && (React__default['default'].createElement(React.Fragment, null,
            clearButtonVisible && (React__default['default'].createElement(coreComponentsButton.Button, { type: 'button', view: 'ghost', disabled: disabled, "aria-label": '\u041E\u0447\u0438\u0441\u0442\u0438\u0442\u044C', className: styles.clearButton, onClick: handleClear },
            ...
            rightAddons,
            error && (React__default['default'].createElement("span", { className: cn__default['default'](styles.errorIcon, colorStyles[colors].errorIcon) })),
            success && !error && (React__default['default'].createElement("span", { className: cn__default['default'](styles.successIcon, colorStyles[colors].successIcon) })))));
    };
