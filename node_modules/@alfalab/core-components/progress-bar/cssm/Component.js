...
var ProgressBar = React__default['default'].forwardRef(function (_a, ref) {
    var className = _a.className, value = _a.value, _b = _a.view, view = _b === void 0 ? 'positive' : _b, dataTestId = _a.dataTestId;
    return (React__default['default'].createElement("div", { role: 'progressbar', "aria-valuenow": Math.round(value), "aria-valuemin": 0, "aria-valuemax": 100, className: cn__default['default'](styles__default['default'].container, className), "data-test-id": dataTestId, ref: ref },
        React__default['default'].createElement("div", { className: cn__default['default'](styles__default['default'].filled, styles__default['default'][view]), style: { transform: "translateX(" + (value - 100) + "%)" } })));
});
