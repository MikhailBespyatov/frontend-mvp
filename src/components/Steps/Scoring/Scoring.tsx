  ...
  return (
    <div className={styles.main_container}>
      <div>
        <img
          alt="Cloud one"
          className={clsx(styles.cloud, styles.cloud_one)}
          src={clouds.one}
        />
        <img
          alt="Cloud two"
          className={clsx(styles.cloud, styles.cloud_two)}
          src={clouds.two}
        />
        <img
          alt="Cloud three"
          className={clsx(styles.cloud, styles.cloud_three)}
          src={clouds.three}
        />
        ...
        <div className={styles.line_wrapper}>
          ...
          <span
            className={clsx(styles.line, {
              [styles.line_active]: scoringStep > 0,
            })}
          ></span>
          <span
            className={clsx(styles.line, {
              [styles.line_active]: scoringStep > 1,
            })}
          ></span>
          <span
            className={clsx(styles.line, {
              [styles.line_active]: scoringStep > 2,
            })}
          ></span>
        </div>
        ...
        <div className={styles.progress_wrapper}>
          <div className={styles.initial_progress}>
            <span className={styles.progress_percent}>
              {PERCENT[scoringStep as keyof typeof PERCENT]}
            </span>
            <div
              className={cn(styles.progress, styles[`progress_${scoringStep}`])}
            ></div>
          </div>
        </div>
